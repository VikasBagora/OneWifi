...
#define SUPP_FREQ_CHANGED_FLAG       BIT(0)
#define SUPP_SIGNAL_CHANGED_FLAG     BIT(1)
#define SUPP_PRIVACY_CHANGED_FLAG    BIT(2)
#define SUPP_MODE_CHANGED_FLAG       BIT(3)
#define SUPP_WPAIE_CHANGED_FLAG      BIT(4)
#define SUPP_RSNIE_CHANGED_FLAG      BIT(5)
#define SUPP_WPS_CHANGED_FLAG        BIT(6)
#define SUPP_RATES_CHANGED_FLAG      BIT(7)
#define SUPP_IES_CHANGED_FLAG        BIT(8)
...
#define RDKB_DBUS_OBJ_PATH_MAX                  64
#define RDKB_DBUS_INTERFACE_MAX 		64
...
#define SUPP_GLOBAL_DBUS_OBJ_NAME "dbus_obj_global"
#define SUPP_INTERFACE_DBUS_OBJ_NAME "dbus_obj_interface"
#define SUPP_BSS_DBUS_OBJ_NAME "dbus_obj_bss"
#define SUPP_NETWORK_DBUS_OBJ_NAME "dbus_obj_network"
...
typedef enum rdkb_dbus_bss_prop {
        rdkb_dbus_bss_prop_signal,
        rdkb_dbus_bss_prop_freq,
        rdkb_dbus_bss_prop_mode,
        rdkb_dbus_bss_prop_privacy,       
        rdkb_dbus_bss_prop_rates,
        rdkb_dbus_bss_prop_wpa,
        rdkb_dbus_bss_prop_rsn,
        rdkb_dbus_bss_prop_wps,
        rdkb_dbus_bss_prop_ies,
        rdkb_dbus_bss_prop_age,
} rdkb_dbus_bss_prop_t;
...
typedef struct rdkb_wifi_supp_param {
	char dbus_new_path[RDKB_DBUS_OBJ_PATH_MAX];
        DBusConnection *dbus_connection;
        size_t num_bss;
        struct circular_list bss; /* rdkb_wifi_bss_t::list */
        scan_list_bss_info_t  scan_bss_info;
        hash_map_t            *bss_handler_args_map;
        hash_map_t            *network_handler_args_map;
...
typedef struct rdkb_wifi_supp_info {
    hash_map_t                *supp_dbus_obj_desc_map;
    rdkb_wifi_supp_param_t    supp_info;
    bool                      is_wifi_supp_conn_init;
...
int rdkb_wifi_dbus_init(rdkb_wifi_supp_info_t **p_wifi_supp);
